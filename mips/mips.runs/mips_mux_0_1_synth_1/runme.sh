...
HD_PWD='D:/BITS/ECE 3-2/CS F342 - COMPUTER ARCHITECHTURE/miniProject/mips/mips.runs/mips_mux_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_mux_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_mux_0_1.tcl
